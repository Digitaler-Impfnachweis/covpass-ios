...
public extension UIColor {
    ...
    static let switchGreen = UIColor("switchGreen")
    ...
    static let backgroundSecondary50 = UIColor("BackgroundSecondary50")

    static let backgroundSecondary60 = UIColor("BackgroundSecondary60")
