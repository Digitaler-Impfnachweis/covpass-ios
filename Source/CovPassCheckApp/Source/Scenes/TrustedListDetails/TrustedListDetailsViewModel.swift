...
private enum Constants {
    enum Keys {
        ...
        static let offlineModusCerts = "app_information_message_update_certificates".localized
        static let offlineModusRules = "app_information_message_update_rules".localized
        static let offlineModusInformation = "app_information_message_update".localized
        static let offlineModusNoteUpdate = "app_information_message_update_note".localized
        static let offlineModusButton = "app_information_message_update_button".localized
    }
    enum Config {
