//
//  VaccinationCycleCompleteResultViewModelTests.swift
//
...
final class VaccinationCycleCompleteResultViewModelTests: XCTestCase {
    ...
    var router: VaccinationCycleCompleteResultRouterMock!
    var sut: VaccinationCycleCompleteResultViewModel!
    ...
    func testTitle() {
        ...
        // Then
        XCTAssertEqual(title, "Full vaccination protection available")
    }
    ...
    func testDescription() {
        ...
        // Then
        XCTAssertEqual(description, "Check the following data against an ID document from the person you are checking.")
    }
