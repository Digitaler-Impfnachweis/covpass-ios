...
class CertificateViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let dccCertLogic = DCCCertLogic(initialDCCRulesURL: Bundle.commonBundle.url(forResource: "dcc-rules", withExtension: "json")!, initialBoosterRulesURL: Bundle.commonBundle.url(forResource: "booster-rules", withExtension: "json")!, service: DCCServiceMock(), keychain: MockPersistence(), userDefaults: MockPersistence())
