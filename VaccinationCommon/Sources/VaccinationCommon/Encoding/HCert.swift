...
public class HCert {
    ...
    func verify(message: CoseSign1Message, certificatePath: String) -> Bool {
        ...
        guard let publicKey = X509_REQ_get_pubkey(getCertificate(from: certContent)) else { return false }
