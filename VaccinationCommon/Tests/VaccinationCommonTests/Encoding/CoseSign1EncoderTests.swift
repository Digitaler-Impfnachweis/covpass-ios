...
class CoseSign1EncoderTests: XCTestCase {
    var sut: CoseSign1Encoder!
    var base45Encoder: Base45Encoder!

    override func setUp() {
        super.setUp()
        sut = CoseSign1Encoder()
    ...
    func testParsing() {
        ...
        let coseSign1Message = sut.parse(decompressedPayload)
...
extension CoseSign1EncoderTests {
