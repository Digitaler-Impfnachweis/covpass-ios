...
open class CardFlowLayout: UICollectionViewFlowLayout {
    ...
    fileprivate func updateLayout() {
        ...
        self.sectionInset = UIEdgeInsets.init(top: yInset, left: 20, bottom: yInset, right: xInset)
    ...
    override open func shouldInvalidateLayout(forBoundsChange newBounds: CGRect) -> Bool { true}
